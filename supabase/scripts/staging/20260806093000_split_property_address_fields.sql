-- Staging database script
-- Apply before deploying app code that reads/writes split property address fields.
-- This script is idempotent and preserves the legacy public.properties.address column.
